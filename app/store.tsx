    ...
    <main>
      ...
      <section className="payment">
        <div className="container payment-grid">
          ...
          <div className="qris-card"><div className="qris-placeholder"><div>QRIS</div><small>Ganti file <b>public/qris.png</b><br/>dengan QRIS kamu</small></div><h3>Bayar dengan QRIS</h3><p>Scan QRIS menggunakan aplikasi pembayaran yang mendukung QRIS.</p></div>
        </div>
      </section>
