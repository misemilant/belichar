...
const characters: Product[] = [
  {
    ...
    description: "Data Polos, Email bisa diganti dan Full Title.",
    ...
    <main>
      ...
      <section className="payment">
        <div className="container payment-grid">
          ...
          <div className="qris-card"><div className="qris-image-wrap" style={{display:"flex", justifyContent:"center", alignItems:"center", overflow:"hidden"}}><img src="/qris.png" alt="QRIS Pembayaran BELICHAR" style={{width:"220px", maxWidth:"100%", height:"auto", display:"block", objectFit:"contain"}} /></div><h3>Bayar dengan QRIS</h3><p>Scan QRIS menggunakan aplikasi pembayaran yang mendukung QRIS.</p></div>
        </div>
      </section>
